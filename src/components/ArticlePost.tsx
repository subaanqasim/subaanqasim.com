...
const ArticlePost = ({
  ...
  return (
    <Link href={`/articles/${slug}`}>
      <a className="group rounded-md border-[3px] border-neutral-300 p-4 transition duration-[250ms] ease-[cubic-bezier(0.5,0,0.15,1)] hover:-translate-y-2 hover:scale-[1.01] dark:border-neutral-600">
