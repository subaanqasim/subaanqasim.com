...
const FeaturedPost = ({ type, title, excerpt, slug }: FeaturedPostProps) => {
  ...
  return (
    <>
      <Link
        href={slug ? `/${urlBase}/${slug}` : "#"}
        className="w-full rounded-lg border-[3px] border-neutral-300 p-4 transition-all hocus:-translate-y-1 hocus:scale-[1.02] dark:border-neutral-600 md:w-1/3"
      >
        <div className="flex h-full flex-col justify-between">
          ...
          <div className="mt-6 flex gap-4 text-sm text-neutral-500 dark:text-neutral-400 md:justify-between">
